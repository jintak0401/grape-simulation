...
const Result = ({ testResultState }: Props) => {
	const router = useRouter();
	const { correctArea, wrongArea, totalCorrect, totalWrong } = testResultState;
			...
			<Container>
				<Fragment>
					...
					<h3 className={styles.description}>
						전반적으로 <br />
						<br />
						<span className={styles.description__circleNum} data-color={'blue'}>
							{circleNum[strong]}
						</span>
						&nbsp; 위치의 버튼을 누를 때 정확하고 빠르며 <br />
						<br />
						<span className={styles.description__circleNum} data-color={'red'}>
							{circleNum[weak]}
						</span>
